...
import { Loader2, Run } from 'lucide-react'; // Using Run icon for running
      ...
      try {
        ...
        if (result.success && result.data) {
          ...
          if (result.data.length === 0) {
            toast({ title: 'No Data', description: 'No running activities found in Firestore for the selected range.', variant: 'default' });
          }
        } else {
          setRunningActivities([]);
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <CardDescription className="text-muted-foreground">
                View your logged running sessions from connected sources.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
