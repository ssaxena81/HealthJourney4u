...
import { Loader2, Hiking as HikingIcon } from 'lucide-react'; // Using Hiking icon
      ...
      try {
        ...
        if (result.success && result.data) {
          ...
          if (result.data.length === 0) {
            toast({ title: 'No Data', description: 'No hiking activities found in Firestore for the selected range.', variant: 'default' });
          }
        } else {
          setHikingActivities([]);
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <CardDescription className="text-muted-foreground">
                View your logged hiking sessions from connected sources.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
